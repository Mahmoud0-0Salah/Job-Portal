...
namespace Jop_Portal.Controllers
{
    public class OffersController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Offers.Include(o => o.User);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,JobTittle,Photo,Description,Available,Active,CreatedAt,UserId")] Offers offers)
        {
            if (id != offers.Id)
            {
                return NotFound();
